    ...
    <>
      <nav className={styles.navbar}>
        <div className={styles.inner}>
          {/* Logo */}
          <Link href="/write" className={styles.logo}>
            <svg className={styles.logoLeaf} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <path d="M3 21c3-3 7-7 11-11" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
          ...
          {/* Write button */}
          <Link href="/" className={`btn btn-primary ${styles.writeBtn}`}>
            <span>✎</span>
            <span>เริ่มจด</span>
          </Link>
        </div>
